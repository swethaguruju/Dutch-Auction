...
import { inferProxyKind, ValidationData, ValidationOptions } from '@openzeppelin/upgrades-core/src/validate';
import { Manifest, DeploymentNotFound, ProxyDeployment } from '@openzeppelin/upgrades-core/src/manifest';
import { isBeaconProxy, isTransparentOrUUPSProxy, isTransparentProxy } from '@openzeppelin/upgrades-core/src/eip-1967-type';
import { Version } from '@openzeppelin/upgrades-core/src/version';
import { BeaconProxyUnsupportedError } from '@openzeppelin/upgrades-core/src/usage-error';
import { UpgradesError } from '@openzeppelin/upgrades-core/src';
