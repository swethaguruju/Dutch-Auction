import { getAnnotationArgs, getDocumentation } from '@openzeppelin/upgrades-core/src/utils/annotations';
import { inferInitializable, inferUUPS } from '@openzeppelin/upgrades-core/src/validate/query';
import { ValidateCommandError } from '@openzeppelin/upgrades-core/src/cli/validate/error';
