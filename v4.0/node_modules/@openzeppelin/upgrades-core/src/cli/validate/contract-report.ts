import _chalk from '@openzeppelin/upgrades-core/node_modules/chalk';
import debug from '@openzeppelin/upgrades-core/src/utils/debug';
import {
  getContractVersion,
  getStorageLayout,
  ValidationOptions,
...
} from '@openzeppelin/upgrades-core/src';
import { Report } from '@openzeppelin/upgrades-core/src/standalone';
import { getUpgradeabilityAssessment } from '@openzeppelin/upgrades-core/src/cli/validate/upgradeability-assessment';
import { SourceContract } from '@openzeppelin/upgrades-core/src/cli/validate/validations';
import { LayoutCompatibilityReport } from '@openzeppelin/upgrades-core/src/storage/report';
import { indent } from '@openzeppelin/upgrades-core/src/utils/indent';
