...
import type { BasicOperation } from '@openzeppelin/upgrades-core/src/levenshtein';
import type { ParsedTypeDetailed } from '@openzeppelin/upgrades-core/src/storage/layout';
import {
  StorageOperation,
  StorageItem,
  StorageField,
  ...
  storageFieldEnd,
  storageFieldBegin,
} from '@openzeppelin/upgrades-core/src/storage/compare';
import { itemize, itemizeWith } from '@openzeppelin/upgrades-core/src/utils/itemize';
...
import { isGap } from '@openzeppelin/upgrades-core/src/storage/gap';
