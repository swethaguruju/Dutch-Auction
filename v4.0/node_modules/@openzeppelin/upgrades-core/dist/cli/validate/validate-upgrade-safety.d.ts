...
import { ProjectReport } from '@openzeppelin/upgrades-core/src/cli/validate/project-report';
/**
 ...
 */
export declare function validateUpgradeSafety(buildInfoDir?: string, opts?: ValidateUpgradeSafetyOptions): Promise<ProjectReport>;
