import { EvmErrorResult, OOGResult } from '@nomicfoundation/ethereumjs-evm/src/evm'
import { ERROR, EvmError } from '@nomicfoundation/ethereumjs-evm/src/exceptions'

import { gasDiscountPairs } from '@nomicfoundation/ethereumjs-evm/src/precompiles/util/bls12_381'

import type { ExecResult } from '@nomicfoundation/ethereumjs-evm/src/evm'
import type { PrecompileInput } from '@nomicfoundation/ethereumjs-evm/src/precompiles/types'
